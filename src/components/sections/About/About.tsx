  ...
  return (
    ...
    <div className="about-me__container">
      <div className="about-me__sub-container">
        ...
        <p className="about-me__text">I’m a newly graduated software engineer who enjoys solving problems and figuring out how the application I’m working on can make the most sense for the people using it. I like thinking a little outside the box when it fits, while still keeping things simple, intuitive, and usable for everyone. </p>
        <p className="about-me__text">I would describe myself as organized and independent, but I really enjoy working with other people. I like bouncing ideas around, asking questions, challenging each other a little, and slowly figuring out the best solution together. I ask a lot of questions when I want to understand something properly, but I do usually still try to solve it myself first, 
          sometimes with a slightly unnecessary amount of stubbornness.</p>
        <p className="about-me__text">Outside of work and school, I love playing board games with friends and family, the more strategic or chaotic, the better. I’m also a big football and Formula 1 fan, especially when I get to play football myself.  I love listening to music and building my LEGO set collections (while watching a relevant TV show or movie connected to the set).</p>
